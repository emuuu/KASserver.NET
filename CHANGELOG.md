...
- Introduced an internal `IKasTransport` seam and added wrapper-level client contract tests (behaviour-preserving; no public API change)
...
- Mailbox actions: `GetMailAccountsAsync`, `AddMailAccountAsync`, `UpdateMailAccountAsync`, `UpdateMailAccountPasswordAsync`, `DeleteMailAccountAsync`
...
[Unreleased]: https://github.com/emuuu/KASserver.NET/compare/kasserver/v1.2.0...HEAD
[1.2.0]: https://github.com/emuuu/KASserver.NET/compare/kasserver/v1.1.0...kasserver/v1.2.0
[1.1.0]: https://github.com/emuuu/KASserver.NET/compare/kasserver/v1.0.0...kasserver/v1.1.0
[1.0.0]: https://github.com/emuuu/KASserver.NET/releases/tag/kasserver/v1.0.0
